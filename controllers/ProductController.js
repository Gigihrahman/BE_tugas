...
export const saveProduct = (req, res)=>{
    ...
    file.mv(`./public/images/${fileName}`, async(err)=>{
        ...
        try {
            await Product.create({name: name, image: fileName,price:price,description:desc, berat:berat,merk:merk, url: url});
...
export const updateProduct = async(req, res)=>{
    ...
    try {
        await Product.update({name: name,price:price,description:desc ,berat:berat,merk:merk,image: fileName, url: url},{
            where:{
                id: req.params.id
            }
        });
...
export const getProductBycategori=async(req,res)=>{
    try {
        ...
        const hasil = await Product.findAll({ where:{
            categoty:category
        },limit, offset});
        const totalProduk = await Product.count();
